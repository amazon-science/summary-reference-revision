...
CS_FILENAME = os.path.join(os.path.abspath(os.getcwd()), 'data', 'concepts_and_synonyms.txt')

# name of the file containing the concept graph
GRAPH_FILENAME = os.path.join(os.path.abspath(os.getcwd()), 'data', 'graph.txt')

# ancestor and descendant node files
ANCESTOR_FILENAME = os.path.join(os.path.abspath(os.getcwd()), 'data', 'ancestors.txt')
DESCENDANT_FILENAME = os.path.join(os.path.abspath(os.getcwd()), 'data', 'descendants.txt')
...
def extract_synonyms(conn):
    ...
    outfile.write("{0}\t{1}\t{2}\t{3}\t{4}\n".format(62, 'icd_code', 6210, 'entity-9 codes', 'PT'))
    outfile.write("{0}\t{1}\t{2}\t{3}\t{4}\n".format(62, 'icd_code', 6211, 'entity-9 code', 'NORM'))
    outfile.write("{0}\t{1}\t{2}\t{3}\t{4}\n".format(62, 'icd_code', 6212, 'entity-10 codes', 'PT'))
    outfile.write("{0}\t{1}\t{2}\t{3}\t{4}\n".format(62, 'icd_code', 6213, 'entity-10 code', 'NORM'))
